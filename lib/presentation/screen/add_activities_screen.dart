...
class AddActivitiesScreen extends StatelessWidget {
  AddActivitiesScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: BlocListener<AddActivitiesCubit, AddActivitiesState>(
  ...
  Widget _submitBtn(context) {
    return InkWell(
      onTap: () {
        BlocProvider.of<AddActivitiesCubit>(context).addActivity(Activities(
      ...
      child: Container(
        ...
        child: Center(
          child: BlocBuilder<AddActivitiesCubit, AddActivitiesState>(
            builder: (context, state) {
